  ...
  return (
    <div className="min-h-screen hero-gradient flex items-center justify-center px-4 py-12">
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-20 right-10 w-72 h-72 rounded-full bg-[#16a34a]/10 blur-3xl" />
        <div className="absolute bottom-10 left-10 w-96 h-96 rounded-full bg-[#0ea5e9]/10 blur-3xl" />
      </div>
      ...
      <Card className="relative w-full max-w-md border-border/50 shadow-xl animate-fade-in-up bg-card">
        <CardHeader className="text-center pb-2">
          ...
          <p className="text-sm text-muted-foreground">Join AgriLink and start growing</p>
        </CardHeader>
        <CardContent>
